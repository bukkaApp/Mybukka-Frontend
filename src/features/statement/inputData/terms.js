export default {
  ...
  lastUpdated: 'Last Updated: January 18, 2019',
  bold: true,
  forewords: 'These Terms provide that with limited exceptions covered by Section 17.3 of these Terms all disputes between you and Bukka arising out of or relating to these Terms or your use of the PLATFORM (the “Disputes”) will be resolved by BINDING ARBITRATION. For such Disputes, YOU waive YOUR RIGHT TO bring a class or representative action, or GO TO COURT under these Terms.',
  forewordConclusion: 'Your rights will be determined by a NEUTRAL ARBITRATOR and NOT a judge or jury, and your claims must be brought individually and not as a class or representative action. Please review Section 17 (“Dispute Resolution and Arbitration”) for the details regarding your agreement to individually arbitrate any Disputes with Bukka.',
  further: [
    "Thank you for your interest in the Bukka application for your mobile device (the 'App') provided to you by Bukka Inc. ('Bukka', 'us' or 'we'), and our web site at Bukka.com (the 'Site'), as well as all related web sites, networks, and downloadable software provided by us and on which a link to these Terms of Service is displayed (collectively, together with the App and Site, our 'Platform'). These Terms of Service (these 'Terms'), including the Privacy Policy incorporated into these Terms by reference and any other applicable policies and guidelines, as may be updated from time to time, govern your use of the Platform. These Terms constitute a legal agreement between you and Bukka. In order to use the Platform you must agree to these Terms.",
  ...
  about: {
    title: 'Bukka PLATFORM',
    content: [
      'The Platform connects consumers with retail stores, and restaurants (“Merchants”), and with independent contractor couriers (“Couriers”), to facilitate on-demand delivery or pickup services. Through the Platform, consumers may request that merchandise or food be made available for pick-up or delivered to them from a Merchant by Couriers who contract with Bukka to access the Platform and receive delivery opportunities.',
      'Bukka is not a retail store, restaurant, food delivery platform, merchandise delivery platform or food preparation entity. Bukka is not liable or responsible for Merchants’ compliance with applicable federal, state, or local laws, rules, regulations or standards pertaining to their businesses. In addition, Bukka does not guarantee the quality of what Merchants sell and does not independently verify, and is not liable for, representations made by Merchants regarding their products on the Platform.',
      'Bukka does not provide Courier services. Couriers are independent contractors and not employees, partners, agents, joint ventures, or franchisees of Bukka. Couriers have entered into independent contractor agreements with Bukka, which require them to comply with all applicable federal, state, and local laws, rules and regulations. Bukka shall not be liable or responsible for any delivery services provided by Couriers, or any errors or misrepresentations made by any of them. You hereby acknowledge that Bukka does not supervise, direct, control, or monitor a Courier’s provision of services and expressly disclaims any responsibility or liability for the services performed.',
      'Bukka is committed to ensuring that the merchandise or food ordered by a consumer is delivered in a manner consistent with consumer’s expectation.',
    ...
    list: [
      ...
      'You consent to the collection, sharing, and use of your personally identifiable information in accordance with Bukka’ Privacy Policy;',
      "The Platform is provided 'as is' without warranties of any kind, and Bukka’ liability to you is limited; and",
      'Disputes arising under these Terms will be resolved by binding individual arbitration.'
    ]
  },
  download: 'BY DOWNLOADING, INSTALLING, OR OTHERWISE ACCESSING OR USING THE PLATFORM, YOU AGREE THAT YOU HAVE READ, UNDERSTOOD, AND AGREE TO BE BOUND BY THESE TERMS. IF YOU DO NOT AGREE, YOU MAY NOT USE THE PLATFORM.',
  scope: 'Bukka (“Bukka,” “we,” “our,” and/or “us”) values the privacy of individuals who use our website and mobile apps (collectively, our “Platform”). This privacy policy (the “Privacy Policy”) explains how we collect, use, and share information from Bukka’ users (“Users”). It applies to our customers (“Customers”), individuals who deliver products requested by Customers through our Platform (“Couriers”), anyone who signs up to become a Courier (“Prospective Couriers”), businesses selling products through our Platform (“Merchants”), and other partners who use our Platform to facilitate delivery of products (“Partners”). By using the Platform, you agree to the Privacy Policy and any future amendments and additions. Your use of our Platform is also subject to our Terms of Service.',
  mainContent: [
    {
      section: 'Eligibility',
      article: [
      ...
      article: [
        {
          ...
          paragraph: [
            ...
            'Because of the nature of the Platform, Bukka does not always know how much a Merchant will charge for a particular product or menu item. Where your cart includes product or menu items for which Bukka does not know the exact price to be charged by the Merchant, Bukka may designate an estimated subtotal for such product and menu items (the “Estimated Subtotal”). Similarly, where Bukka does not know the exact price of certain or all fees associated with the order, including any applicable taxes and/or Bukka fees, we may designate an estimate for such fees (the “Estimated Fees”). If you have included product or menu items in your cart that are subject to Estimated Subtotal and/or Estimated Fees, we will provide you with an estimated total. Merchants may charge more or less than the Estimated Subtotal for products or menu items you order. Similarly, we may charge more or less than the Estimated Fees based upon the final prevailing price of Merchant’s goods. In some cases, we may not be able to provide Estimated Subtotal or Estimated Fees, such as when the merchandise cost is unknown or we are otherwise unable to predict fees. Bukka reserves the right to determine final prevailing pricing of all product or menu items ordered through the Platform. In cases in which prevailing pricing is different than the Estimated Subtotal and/or Estimated Fees, what you are ultimately charged may be different than the estimated total. You acknowledge and agree to pay the prevailing pricing and fees, even if they differ from the Estimated Subtotal and/or Estimated Fees. Please visit our Help Center to learn more about how product or menu items are priced.',
            'Certain features of the Platform, including placing orders, may require you to pay fees to Bukka. Bukka may change, or add, fees for use of our Platform at any time as we deem necessary or appropriate for our business. You will have an opportunity to review and accept an estimate of the fees that you will be charged, as applicable. The final fees may differ from the estimate. In all cases, you acknowledge and accept that a fee will be charged and you agree to pay said fee. We encourage you to check our Site or visit our Help Center periodically to learn more about how we charge for the Platform.',
            'Bukka has no obligation to itemize its costs, profits or margins when publishing prices on the Platform and reserves the right to change such prices at any time, at its discretion. You are liable for all transaction taxes on the Platform provided under these Terms (other than taxes based on Bukka’ income).',
            'Bukka will charge the payment method you specify at the time of purchase or as otherwise specified by you in your account information. We may also place a pre-authorization hold on your payment method, as described in Section 4.3.',
            'Charges paid by you are final and non-refundable, except as expressly provided in Section 4.2, and will be quoted in the local currency of the location where the order is being delivered or picked up. Except as expressly provided in Section 4.2, Bukka has no obligation to provide refunds or credits. However, Bukka, in its sole discretion, may provide users with refunds, courtesy delivery or product credits, or make promotional offers with different features and different rates to any consumers. These credits and offers may be used for future transactions on the Platform. Such credits or offers are non-transferrable, may not be resold, and are not redeemable for cash or other consideration. Bukka reserves its right to expire, limit, or modify any credits or promotion at any time. If your account is cancelled for any or no reason, you may forfeit any pending, current, or future credits or promotional offers and any other forms of unredeemed value in or associated with your account without prior notice to you.',
            'Referral Program',
            'Bukka may offer a referral program (“Referral Program”), allowing consumers to earn courtesy delivery or product credits, or other promotional rewards (“Referral Program Rewards”) by inviting their eligible friends to register as new Bukka consumers using a unique referral code (“Referral Program Codes”). Referral Program Codes must be used for the intended audience and purposes, and may not be sold or transferred in any manner or made available to the general public (whether posted to a public forum or otherwise), unless expressly permitted by Bukka. Referral Program Rewards are non-transferrable, may not be resold, and are not redeemable for cash or other consideration. You agree we may change the terms and conditions of the Referral Program, terminate the Referral Program, or expire, deduct, limit, or modify your Referral Program Rewards at any time for any reason, including but not limited to, the event that Bukka determines or believes that your participation in the Referral Program or use or redemption of Referral Program Codes was in error, fraudulent, illegal, or otherwise in violation of these Terms. You can learn more about Bukka’ Referral Program here.'
          ]
        },
        {
          heading: 'Unlimited Subscription',
          paragraph: [
            'Bukka Unlimited (“Unlimited”) is offered as a monthly or yearly pre-paid subscription to the Platform on a per account basis. By signing up for Unlimited and providing us with your payment account information, you are signing up to an auto-renewing subscription requiring recurring payments and agree to pay the then-current applicable fee associated with the subscription.',
            ...
            'If your subscription includes a free trial, you will not be charged the applicable fee during your free trial. To obtain the free trial you will be required to provide a credit card in order to ensure uninterrupted access to Unlimited and continued use after the expiration of the free trial. Upon completion of your free trial, your subscription will automatically convert into a paid Unlimited subscription and your payment method will be charged the applicable fee unless you have cancelled your Unlimited subscription. You may cancel your Unlimited subscription as described below. You may not receive a notice from us that your free trial has ended or that the paying portion of your Unlimited subscription has begun. You are only permitted one free trial. If your Unlimited subscription is ever terminated for any reason, and you purchase an additional Unlimited subscription, you shall not be eligible for a free trial on any subsequent Unlimited subscriptions.',
            ...
            'We may terminate your subscription for Unlimited at our discretion and without any notice. If we cancel your yearly subscription for Unlimited, we will give you a prorated refund based on the amount of time remaining in your pre-paid subscription; provided, however, that Bukka will not be obligated to grant you a refund if we terminate your account or your subscription because we determine, in our sole discretion, that your actions or your use of the Platform violates these Terms or has harmed another user.'
          ]
        },
        {
          heading: 'Payment Authorization',
          paragraph: [
            'You authorize Bukka to charge all sums for orders that you make to the payment method designated in your account. When you place an order order through Bukka, a temporary pre-authorization hold is placed on your designated payment method to verify that the card is valid and has funds available for your intended purchase. The amount of this pre-authorization hold may be greater or less than the order total quoted at checkout. However, your payment will be captured up to 24 hours after your order is completed or cancelled. In the event that the pre-authorization is greater than the final amount, the difference will be released after your order is completed or cancelled; depending on your bank, it may take up to 5 business days to receive access to these released funds.',
            'Bukka also places an initial temporary pre-authorization hold on each new payment method you add to your account.',
            'Bukka reserves the right to request additional information from you if we have reason to believe, in our sole discretion, that a payment method may be fraudulent.'
          ]
        },
        {
          heading: 'Delinquent Accounts',
          paragraph: [
            'If payment due on your account is delinquent, we reserve the right to suspend or terminate your access to the Platform; your account information may be sent to a collection agency/debt collector and you may be subject to a collection action, and payment of collection related fees and costs. If any fee for your Unlimited subscription is not paid in a timely manner, we reserve the right to revoke access to your Unlimited subscription and use of Bukka. If you do not bring your Bukka balance current after we provide you with notification that your account is in arrears, we reserve the right to suspend or terminate your access to your Unlimited subscription or convert your Unlimited subscription to a non-subscription account. You will be responsible for paying all past due amounts. If you have questions regarding an outstanding balance on your account, please contact us via our Help Center.',
        ...
        {
          heading: 'Consumer Not Available',
          paragraph: [
            'Bukka reserves the right to charge you the full order amount, including any Bukka fees, if you are not at the designated delivery location when the Courier arrives to complete the delivery or if you fail to pick up an order from a Merchant.'
          ]
        },
        {
        ...
        },
        {
          heading: 'Gift Cards',
          paragraph: [
            'Bukka may provide you with the option to purchase or redeem gift cards in connection with your use of the Platform. You agree that you will comply with all gift card terms and conditions, which are located here. You can learn more about gift cards in our Help Center.'
          ]
        }
      ]
    },
    {
      section: 'Third-Party Interactions',
      article: [
        {
          heading: 'Third-Party Providers',
          paragraph: [
            'During use of the Platform, you may purchase goods and services from third-party Merchants through the Platform. Any such activity, and any interactions, disputes, terms, conditions, warranties or representations associated with that activity, is solely between you and the applicable third-party Merchant. Bukka and its licensors shall have no liability, obligation or responsibility for any purchase or transaction between you and any third-party provider. In no event shall Bukka or its licensors be responsible for any content, products, services or other materials on or available from third-party sites or third-party providers. Certain third-party providers of goods and/or services may require your agreement to additional or different terms and conditions prior to your use of or access to such goods or services, and Bukka disclaims any and all responsibility or liability arising from such agreements between you and a third party.'
          ]
        },
        {
          heading: 'Couriers',
          paragraph: [
            'The Platform enables you to engage third-party Couriers to provide delivery services. Any interactions or disputes between you and a Courier are solely between you and that Courier. Bukka and its licensors shall have no liability, obligation or responsibility for any interaction between you and any Courier.'
          ]
        },
        {
    ...
    {
      section: 'Your Use of the Platform',
      article: [
        {
          heading: '',
          paragraph: [
          ...
          list: [
            ...
            'You agree not to use, display, mirror, frame or utilize framing techniques to enclose the Platform, or any portion thereof, unless and solely to the extent Bukka makes available the means for embedding any part of the Platform;',
            'You agree not to access, tamper with, or use non-public areas of the Platform, Bukka’ (and its hosting company’s) computer systems and infrastructure, or the technical delivery systems of Bukka’ providers;',
    ...
    {
      section: 'Consent to Use of Data',
      article: [
        {
          heading: '',
          paragraph: [
            'Please see Bukka’ Privacy Policy, for more information regarding information Bukka collects, and how it uses and shares that information.'
          ]
        }
      ]
    },
