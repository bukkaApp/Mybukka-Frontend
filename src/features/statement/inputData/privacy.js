export default {
  ...
  lastUpdated: 'Last Updated: February 27, 2019',
  forewords: 'At Bukka, your privacy is important to us. In this Privacy Policy, we tell you what information we collect, share with others, and how we use it.',
  privacyScope: 'Scope of this Privacy Policy',
  ...
  mainContent: [
    {
      section: 'Information You Provide Directly to Us',
      article: [
        {
          heading: 'Information Provided by Customers',
          paragraph: [
            "'Sign Up and Profile Information'. When you sign up and/or place an order through Bukka as a Customer, you provide us with information, including, but not limited to your name, email address, physical address, and phone number. If you sign up using your Facebook account, we receive information including your name and email address. After registration, Customers can add multiple delivery addresses to their profile. You may be required to provide us with a photograph.",
            "'Payment Information'. When you add a payment card to your Bukka account, a third-party payments service provider receives your card information. We do not store full payment card information on our servers."
          ]
        },
        {
          heading: 'Information Provided by Prospective and Active Couriers',
          paragraph: [
            "'Profile Information'. A Merchant who signs up for our Platform provides us with certain information, including, but not limited to the business’s physical address, hours, and product information, including product details and price.",
            "'Payment Information'. We may receive Merchants’ bank account information to provide payment."
          ]
        },
        {
          heading: 'Information Provided by All Users',
          paragraph: [
    ...
    {
      section: 'Other Information We Collect Through Your Use of the Platform',
      article: [
        {
          heading: '',
          paragraph: [
            'Location and Sensor Information. We receive a Customer’s location information when you’re using the Bukka app, including when the app is in use in the foreground or background. We may continuously collect location information and other motion-generated or orientation-generated mobile sensor data from Couriers and Prospective Couriers when the Bukka app is in use in the foreground or background in order to personalize the app experience, assist in finding available markets and/or available delivery opportunities, offer delivery incentives, track the progress and completion of deliveries, and other similar purposes. We also use this information for analytics purposes. For information on your choices for sharing location information, please consult Section 7 on Your Choices.',
            'Referrals. You may be able to refer Bukka to friends and other contacts. To help you do this, we may request and you can grant us access to your mobile device address book. You can then direct us to send referral text messages or referral emails to contacts you select in your address book. We will use the data from your address book only to process your referral. By sending a referral, you also consent to Bukka sending your public profile image to the contacts you select to receive a referral link.',
    ...
    {
      section: 'Information We Receive from Third Parties',
      article: [
        {
          heading: 'Information We Receive About Customers',
          paragraph: [
            'Partners. If you make a purchase through one of our Partners that offers delivery via Bukka, we receive information about your purchase, including your name, phone number, the product you purchased, and the delivery location.'
          ]
        },
        {
          heading: 'Additional Information We Receive About Prospective and Active Couriers',
          paragraph: [
            'Background Information on Couriers. Bukka works with third-party providers to perform driving record and criminal background checks on Prospective and active Couriers, and in some instances these third parties provide Prospective and active Couriers’ records to Bukka as part of the background check process.'
          ]
        },
        {
          heading: 'Information From Affiliates and Non-Affiliated Third Parties',
          paragraph: [
            'We may collect information about you or others through Bukka affiliates or through non-affiliated third parties. For example, you may be able to access the Platform through a social networking account, such as Facebook. If you access the Platform through your Facebook account, you may allow us to have access to certain information in your Facebook profile. This may include your name, profile picture, gender, networks, and/or email address and other information you allow to be imported from Facebook, which is controlled in your Facebook privacy settings.',
    ...
    {
      section: 'How We Use Information We Collect',
      article: [
        {
          heading: 'Uses of Information Collected from All Users',
          paragraph: [
    ...
    {
      section: 'How Bukka Shares Information It Collects From Users',
      article: [
        {
          heading: 'Sharing between Customers and Couriers',
          paragraph: [
        ...
        {
          heading: 'Sharing between Couriers and Merchants',
          paragraph: [
        ...
        {
          heading: 'Sharing between Customers and Merchants',
          paragraph: [
        ...
        },
        {
          ...
          list: [
            ...
            'With law enforcement officials, government authorities, or third parties, if we think doing so is necessary to protect the rights, property, or safety of Bukka, our Users, or the public;',
      ...
      article: [
        {
          ...
          paragraph: [
            ...
            'Account Deletion. If you would like to delete your Bukka account, please contact us through our Help Center with your request. If you choose to delete your account, we will delete it for you, but may retain your account information to collect any fees owed, resolve disputes, troubleshoot problems, analyze usage of the Platform, assist with any investigations, prevent fraud, enforce our Terms of Service, or take other actions as required or permitted by law and/or regulations.'
          ]
        }
      ]
    },
      ...
      article: [
        {
          heading: '',
          paragraph: [
            'Bukka is not directed to children, and we do not knowingly collect personal information from children under 13. If you believe that a child under the age of 13 has given us personal information, please contact us via our Help Center.'
          ]
        }
      ]
    },
    ...
    {
      section: 'Your California Privacy Rights',
      article: [
        {
          heading: '',
          paragraph: [
