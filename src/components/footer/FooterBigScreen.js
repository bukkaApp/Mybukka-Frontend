...
const FooterBigScreen = ({ fixed, totalCost = 0, price, handleClick, withQtyBtn, left, qty, text = 'Add to Cart' }) => {
  ...
  return (
    <div className={`${fixed ? 'Footer-BigScreen-Fixed' : 'Footer-BigScreen'}`}>
      ...
      <button onClick={handleClick} type="submit" data-add-to-cart="true" className="Footer-BigScreen-Button">
